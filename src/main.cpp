...
// Copyright (c) 2011-2013 MemeCoin Developers.
...
uint256 hashGenesisBlock("0xe8a2eaf89eb794aeee1ab448053e3badbecc63d45b638633edcfdd60a02100c4");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 5); // MemeCoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 5 * 60 * 2 * 30; // MemeCoin: 5 hours
static const int64 nTargetSpacing = 1 * 30; // MemeCoin: 30 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal MemeCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MemeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe8a2eaf89eb794aeee1ab448053e3badbecc63d45b638633edcfdd60a02100c4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Hail Lord BAZ 5/18/2013";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1367867452;
        block.nBits    = 0x1e7fffff;
        block.nNonce   = 10013;

        if (fTestNet)
        {
            block.nTime    = 1367867452;             //test net not supported
            block.nNonce   = 0;
        }
		...
		assert(block.hashMerkleRoot == uint256("0x46385a2e69b2569c6d9f20afff2524ade76fac41023aa4ff05fb8b9b0a6fa014"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // MemeCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
