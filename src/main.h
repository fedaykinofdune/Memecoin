...
static const int64 MAX_MONEY = 100000000 * COIN; // 200m total coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 480 / 250; // MemeCoin: 480 blocks found a day. Priority cutoff is 1 MemeCoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("04a5814813115273a109cff88807ba4a05d951873dae7acb6c973d0c9e7c88911a3dbc9aa600deac241b91707e7b4ffb30ad91c8e56e695a1ddf318592988afe0a")))
